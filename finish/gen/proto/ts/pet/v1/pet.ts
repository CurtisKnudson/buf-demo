...
import { Order } from "../../payment/v1alpha1/payment";
...
/**
 * @generated from protobuf message pet.v1.PurchasePetRequest
 */
export interface PurchasePetRequest {
    /**
     * @generated from protobuf field: string pet_id = 1;
     */
    petId: string;
    /**
     * @generated from protobuf field: payment.v1alpha1.Order order = 2;
     */
    order?: Order;
}
/**
 * @generated from protobuf message pet.v1.PurchasePetResponse
 */
export interface PurchasePetResponse {
}
/**
...
// @generated message type with reflection information, may provide speed optimized methods
class PurchasePetRequest$Type extends MessageType<PurchasePetRequest> {
    constructor() {
        super("pet.v1.PurchasePetRequest", [
            { no: 1, name: "pet_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "order", kind: "message", T: () => Order }
        ]);
    }
    create(value?: PartialMessage<PurchasePetRequest>): PurchasePetRequest {
        const message = { petId: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<PurchasePetRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PurchasePetRequest): PurchasePetRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string pet_id */ 1:
                    message.petId = reader.string();
                    break;
                case /* payment.v1alpha1.Order order */ 2:
    ...
    internalBinaryWrite(message: PurchasePetRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string pet_id = 1; */
        if (message.petId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.petId);
...
/**
 * @generated MessageType for protobuf message pet.v1.PurchasePetRequest
 */
export const PurchasePetRequest = new PurchasePetRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PurchasePetResponse$Type extends MessageType<PurchasePetResponse> {
    constructor() {
        super("pet.v1.PurchasePetResponse", []);
    }
    create(value?: PartialMessage<PurchasePetResponse>): PurchasePetResponse {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<PurchasePetResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PurchasePetResponse): PurchasePetResponse {
        return target ?? this.create();
    }
    internalBinaryWrite(message: PurchasePetResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message pet.v1.PurchasePetResponse
 */
export const PurchasePetResponse = new PurchasePetResponse$Type();
/**
...
export const PetStoreService = new ServiceType("pet.v1.PetStoreService", [
    ...
    { name: "PurchasePet", options: {}, I: PurchasePetRequest, O: PurchasePetResponse }
]);
